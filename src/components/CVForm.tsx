...
// Default-Daten basierend auf Eike Brenneisens CV
const createDefaultCV = (): CVData => ({
  ...
  experience: [
    {
      ...
      achievements: [],
      keywords: ['Program Management', 'IT Transformation', 'Sales Optimization'],
      technologies: [],
    },
    {
      id: crypto.randomUUID(),
      ...
      achievements: [],
      keywords: ['Project Management', 'Process Optimization'],
      technologies: [],
    },
    {
      id: crypto.randomUUID(),
      company: 'Bank (Ausbildung)',
  ...
  projects: [
    {
      id: crypto.randomUUID(),
      name: 'Insurance Sales Transformation',
      ...
      endDate: '',
      duration: '2022 - heute',
      description: 'Strategic program management of a transformation in insurance sales, including implementation of modern IT systems, complexity reduction, and process digitization. Conducting big data analyses to ensure optimal project execution within a sales transformation framework, as well as simulation of commission models.',
      technologies: ['ServiceNow', 'Power BI'],
      achievements: [],
      keywords: ['IT Transformation', 'Sales Optimization', 'Big Data'],
    },
    {
      id: crypto.randomUUID(),
      name: 'Banking Sales Network Transformation',
      ...
      endDate: '2022-05',
      duration: '2021 - 2022',
      description: 'Planning, coordination, and execution of process optimization for sales and controlling systems to enable automated sales monitoring. Project management for the transformation of a universal bank\'s sales network, focusing on digital sales, including the introduction of modern CRM systems.',
      technologies: ['MS Dynamics CRM', 'Power BI'],
      achievements: [],
      keywords: ['CRM Implementation', 'Process Optimization', 'Digital Sales'],
    },
    {
      id: crypto.randomUUID(),
      ...
      endDate: '2020-12',
      duration: '2020',
      description: 'Development of a regulatory gap analysis, including the creation of an action plan for a Luxembourg-based investment fund. Execution of a tax impact analysis and project management to ensure compliance with new legal and tax requirements.',
      technologies: [],
      achievements: [],
      keywords: ['Regulatory Compliance', 'Tax Analysis', 'Investment Funds'],
    },
  ],
});
